    ...
    <van-form @submit="onSubmit">
      <van-cell-group inset>
        ...
        <van-field
            ...
            :placeholder="addTeamData.expireTime ?? 'Click to select the expiration time'"
        ...
        <van-popup v-model:show="showPicker" position="bottom">
          <van-date-picker
              @confirm="onConfirm"
              type="datetime"
              title="Please select the expiration time"
              :min-date="minDate"
          />
        </van-popup>
        <van-field name="stepper" label="Maximum number of members">
          <template #input>
        ...
        <van-field
            ...
            name="password"
            label="Password"
            placeholder="Please enter team password"
